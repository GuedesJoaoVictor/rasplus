...
public class UserPaymentInfo {
    ...
    public UserPaymentInfo(String cardNumber, Long cardExpirationNumber, Long cardExpirationYear, String cardSecurityCode, BigDecimal price, LocalDate dtPayment, User user) {
        this.cardNumber = cardNumber;
        this.cardExpirationMonth = cardExpirationNumber;
