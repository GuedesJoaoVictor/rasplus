...
public class User implements Serializable {
    ...
    public User(String name, String email, String phone, String cpf, LocalDate dtSubscription, LocalDate dtExpiration, UserType userType, SubscriptionType subscriptionType) {
        this.name = name;
        this.email = email;
        this.phone = phone;
        this.cpf = cpf;
